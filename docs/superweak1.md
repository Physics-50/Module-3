...
When setting up your experiment, make sure the range over which you vary the parameter is of significance to the experiment. For example, if you are varying the angle of the diffraction grating, you will gain more useful information by focusing on the effect at small angles (\lesssim 10 \degrees). 
