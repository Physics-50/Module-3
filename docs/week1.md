...
Note: below is the derivation for the interference pattern due to double slit interference. However, please don't get bogged down in the details. The takeaway (#takeaway) is further down</a>.
...
One can use this equation to measure the the spacing between slits that are less than a tenth of a millimeter apart using nothing but a meter stick!</strong>
