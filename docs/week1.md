...
<img class="wp-image-1859 size-full" src="https://www.physics.hmc.edu/~physics50/wp/wp-content/uploads/2018/10/WavesBest2.png" alt="" width="1440" height="927"> <strong>Figure 5:</strong> Simplified interference pattern for an electromagnetic wave propagating through a double slit. The bold dots emphasize constructive interference. Here, H_i denotes the ith antinode (a point of high intensity), x the distance |H_0-H_1|, d the slit separation distance, and L the distance from the slit plane to the background on which the interference pattern is observed. Note that the distances displayed in the figure are not to scale. In reality, d&lt;&lt; L and d&lt;x.
