...
In special relativity we treated light as individual particles of light called photons. However, as you learned in Physics 51 (or will learn shortly!), light is an electromagnetic wave -- periodic fluctuations of the electric and magnetic fields that travel at the speed of light. It turns out that light exists as both a wave and a particle. For the remainder of this section we treat light as an electromagnetic wave and not as a particle. The particle treatment is pursued at the end of Physics 51 and, if you choose to continue taking physics at Mudd, the beginning of Physics 52.</p>
...
[caption id="attachment_1870" align="aligncenter" width="800"]<img class="size-full wp-image-1870" src="https://www.physics.hmc.edu/~physics50/wp/wp-content/uploads/2018/10/water-diffraction-ocean.jpg" alt="" width="800" height="528"> Figure 1: A photo off the coast of Australia showing the diffraction of a wave as it passes from right to left through an aperture, or opening, in an otherwise barrier of rocks. Photo credit Google Earth.[/caption]
...
[caption id="attachment_1878" align="aligncenter" width="600"]<img class="wp-image-1878 size-full" src="https://www.physics.hmc.edu/~physics50/wp/wp-content/uploads/2018/10/single-slit.jpg" alt="" width="600" height="236"> Figure 2: The diffraction pattern from a monochromatic light source traveling through a single slit aperture.[/caption]
...
[caption id="attachment_1868" align="aligncenter" width="300"]<img class="size-full wp-image-1868" src="https://www.physics.hmc.edu/~physics50/wp/wp-content/uploads/2018/10/double-slit.png" alt="" width="300" height="241"> Figure 3: a slide with two identical slits[/caption]
<p style="text-align: justify;">The light passing through two slits will now create a pattern as shown below in figure 4.</p>


[caption id="attachment_1881" align="aligncenter" width="600"]<img class="size-full wp-image-1881" src="https://www.physics.hmc.edu/~physics50/wp/wp-content/uploads/2018/10/double-slit-green.jpg" alt="" width="600" height="236"> Figure 4: Diffraction pattern from laser light passing through a double slit.[/caption]
...
Note: below is the derivation for the interference pattern due to double slit interference. However, please don't get bogged down in the details. The <a href="#youngs">takeaway is further down</a>.
<p style="text-align: justify; padding-left: 60px;">Let us now work out some of the mathematical relationships between the observed diffraction patterns and the experimental parameters of our system, following the schematic diagram in figure 5 below.&nbsp; Once we know these relationships we can use slits with known properties to study the wavelength of light, or conversely use light with a known wavelength to study the properties of a particular set of slits.</p>


[caption id="attachment_1859" align="aligncenter" width="1440"]<img class="wp-image-1859 size-full" src="https://www.physics.hmc.edu/~physics50/wp/wp-content/uploads/2018/10/WavesBest2.png" alt="" width="1440" height="927"> <strong>Figure 5:</strong> Simplified interference pattern for an electromagnetic wave propagating through a double slit. The bold dots emphasize constructive interference. Here, H_i denotes the ith antinode (a point of high intensity), x the distance |H_0-H_1|, d the slit separation distance, and L the distance from the slit plane to the background on which the interference pattern is observed. Note that the distances displayed in the figure are not to scale. In reality, d&lt;&lt; L and d&lt;x.[/caption]
<p style="text-align: justify; padding-left: 60px;">In figure 5, a light beam incident on a double slit is initially a plane wave moving in one direction (upwards from the bottom of the diagram). When the wave hits the barrier with the two slits, the wave essentially splits into two smaller waves that emanate from the two slits. This is called <strong>Huygen's principle</strong>.&nbsp; Interference between the two expanding waves causes a pattern of bright spots -- antinodes -- and dark spots -- nodes -- on the screen.&nbsp; $latex H_0$ and $latex H_1$ denote the position of the central and first non-central antinode, respectively, and we define $latex x = |H_0 - H_1|$ to be the antinode separation distance. Let $latex d$ be the slit separation distance and $latex L$ the distance from the slit plane to the background upon which the interference pattern is observed. While figure 5 is a schematic of a double-slit interference experiment, we can also think of it as the pattern of waves produced by dropping two stones simultaneously into a calm body of water. Here the separation distance between the two stones is analogous to the slit separation distance $latex d$. The ripples produced by a single stone will propagate outward in concentric circles about the location where the stone contacted the water.&nbsp; In the figure, bold dots represent positions where wave crests are interfering constructively with each other---that is, a subset of the positions where the two waves are in phase and superpose.&nbsp; Notice that constructive interference happens at certain angles away from the upwards, or straight-ahead, direction, leading to the specific bright spots $latex H_i$ on the screen.</p>
<p style="text-align: justify; padding-left: 60px;">To formulate an expression for the wavelength of the monochromatic source, we zoom in on the light waves near the slits, as shown in Figure 6 below. Here, point $latex B$ denotes the spot halfway between the two slits, <em>i.e.</em>, the midpoint of $latex d$. The line segments $latex \overline{BH_1}$ and $latex \overline{BH_0}$ represent the constructive interference paths leading from the slits to $latex H_1$ and $latex H_0$, respectively, as shown in Figure 1. Because $latex L\gg d$, it follows that $latex \overline{BH_1}\gg d$, and also that both segments $latex \overline{Slit1H_1}$ and $latex \overline{Slit2H_1}\gg d$. Under these extreme inequalities, we make the assumption $latex \gamma = 0^{\circ}$, which implies that $latex \alpha = 90^{\circ}$. (<em>Note:</em> The picture greatly exaggerates the distance $latex d$, so it does not look like the approximation is valid. You might try re-drawing the figure with a much smaller $latex d$ and/or much larger $latex L$ to get a sense for why the approximation works.&nbsp; In real situations $latex L$ is often at least six orders of magnitude greater than $latex d$. That's the difference between <em>one&nbsp;centimeter</em> and <em>ten&nbsp;kilometers</em>.) It follows that $latex \overline{Slit1H_1}\parallel\overline{BH_1}\parallel\overline{Slit2H_1}$.</p>


[caption id="attachment_1865" align="aligncenter" width="600"]<img class="wp-image-1865" src="https://www.physics.hmc.edu/~physics50/wp/wp-content/uploads/2018/10/Waves6-2-1024x765.png" alt="" width="600" height="448"> Figure 6. Note: lengths not to scale. Because L &gt;&gt; x&gt;d, we make the assumption gamma ~ 0, implying that the line between Slit 1 and H_1 is parallel to the line connecting B and H_1 and also to that connecing Slit2 and H_1; alpha ~ 90 degrees.&nbsp; The supplement of alpha must also be ~90 degrees. Further geometric and trigonometric analyses yield (1).[/caption]
<p style="padding-left: 60px;">Additionally, because we know that the two superimposed waves from Slit 1 and Slit 2 are in phase when they arrive at $latex H_1$ (and not anywhere else between $latex H_1$ and $latex H_0$), it must be that the difference between the path lengths $latex \overline{Slit2H_1}$&nbsp; and $latex \overline{Slit1H_1}$ is the wavelength $latex \lambda$ of the monochromatic source. That is, $latex \lambda = \overline{Slit2A}$. It follows, therefore, that $$ \lambda \approx d \sin \theta $$ But since, under these conditions where the screen is much further away than the slits are separated, $latex \theta \approx \beta$, we also have that $latex \tan \theta \approx \tan\beta = x / L$. If the angle $latex \theta$ is small then we can use the small angle approximation $latex \sin \theta \approx \tan\theta$. Equating these two tangent expressions gives us $$\frac{x}{L}= \frac{\lambda}{d}. \tag{1}\label{eq:simplified_young}$$ where&nbsp;<em>x</em> is the distance between the central maximum and the first bright spot, <em>L</em> is the distance between the slit and the screen, $latex \lambda $ is the wavelength of the laser and&nbsp;<em>d</em> is the spacing between the slits.</p>
<strong>Takeaway: One can use this equation to measure the the spacing between slits that are less than a tenth of a millimeter apart using nothing but a meter stick!</strong>
<p style="text-align: justify; padding-left: 60px;">Notice how we derived (\ref{eq:simplified_young}) by measuring the distance $latex x$ between the first antinode and the central maximum. A similar equation follows by measuring the distance $latex \chi$ between the $latex m$th antinode and the central maximum.&nbsp; The only difference is that now the path difference is $latex m\lambda$ as opposed to just $latex \lambda$. In this case, the generalization of (\ref{eq:simplified_young}) is $$\frac{\chi}{L}= \frac{m\lambda}{d}. \tag{2}\label{eq:youngs}$$ Note, however, that as one proceeds further away from the central maximum, the assumption that the paths from the two slits to $latex H_i$ are parallel to each other may begin to break down.</p>
